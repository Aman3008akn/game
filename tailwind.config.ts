		...
		extend: {
			colors: {
				...
				cricket: {
					...
					'primary-foreground': 'hsl(var(--cricket-primary-foreground))',
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': {
						boxShadow: '0 0 20px hsl(142 82% 55% / 0.3)'
					},
					'50%': {
						boxShadow: '0 0 30px hsl(142 82% 55% / 0.6), 0 0 40px hsl(142 82% 55% / 0.3)'
					}
				}
			},
			animation: {
